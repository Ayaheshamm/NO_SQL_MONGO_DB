//Q1. Create + Use ITI_Mongo
use ITI_Mongo
use iti
db.fatma.insertOne ({name:"fatma"})
...
//Q3.Insert one document into the 
//"Staff" collection: {_id, name, age, gender, department}.
...
//Q4.Insert many documents into the "Staff" collection:
db.Staff.insertMany([
  { _id: 2, name: "Mohamed", age: 20, gender: "male", department: "HR" },
  { _id: 3, name: "Sara", age: 25, gender: "female", managerName: "Ahmed", department: "IT" },
  { _id: 4, name: "Layla", age: 15, gender: "female", DOB: "2009-01-01" }
])
...
//5.2 — Find where gender is "male":
db.Staff.find({ gender: "male" })

//5.3 — Find age between 20 and 25:
db.Staff.find({ age: { $gte: 20, $lte: 25 } })

//5.4 — Find age is 25 AND gender is "female":
db.Staff.find({ age: 25, gender: "female" })

//5.5 — Find age is 20 OR gender is "female":
db.Staff.find({ $or: [{ age: 20 }, { gender: "female" }] })

//Q6.Update one document in the "Staff" collection
// where age is 15, set the name to "your name".
db.Staff.updateOne(
  { age: 15 },
  { $set: { name: "Aya" } }
)
...
//Q7.Update many documents in the "Staff" collection, 
//update the department to "AI".
db.Staff.updateMany(
  {},
  { $set: { department: "AI" } }
)
...
//Q8.Create "test" Collection and Insert Same Data from Task 4
db.test.insertMany([
  { _id: 2, name: "Mohamed", age: 20, gender: "male", department: "HR" },
  { _id: 3, name: "Sara", age: 25, gender: "female", managerName: "Ahmed", department: "IT" },
  { _id: 4, name: "Layla", age: 15, gender: "female", DOB: "2009-01-01" }
...
//Q9.
//a. Delete ONE document where age is 15
db.test.deleteOne({ age: 15 })

//test 
db.test.find()

//b. Insert Two Documents with age 15, Then Test deleteOne
...
//Q10.Delete All Male Gender from "test" Collection
